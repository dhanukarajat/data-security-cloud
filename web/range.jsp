...
<%
	...
	String[] q1=q.split("\\.");
	String query=q1[0];
	System.out.println("this is range query:"+query);
	for(String t:q1){
	...
	ResultSet rt=st.executeQuery("select * from files where filename like '"+query+"%' and owner_name='"+session.getAttribute("UNAME").toString()+"'");
...
<div id="page">
	...
	<div style="font-size: 15px;">
		<div class="post" id="ulogin">
                    <center>
			<h2 class="title"style="color: coral">RANGE QUERY PROCESSING </h2>
